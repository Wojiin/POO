...
//Accélérer
    public function accelerer($speed){
        if ($this->_vitesseActuelle > 0){
            ...
            return " Le véhicule $this->_marque $this->_modele accélère à $this->_vitesseActuelle km/h <br>";
        }
...
//Décélérer
        ...
        if ($speed > $this->_vitesseActuelle){
            $this->_vitesseActuelle = 0;
        return "Le véhicule $this->_marque $this->_modele est immobilisé <br>";
    }
        if ($this->_vitesseActuelle > 0){
            $this->_vitesseActuelle -= $speed;
            return " Le véhicule $this->_marque $this->_modele décélère à $this->_vitesseActuelle km/h <br>";
        }
    }
//Stopper
...
echo $v1-> accelerer(50);
echo $v1-> accelerer(50);
echo $v1-> decelerer(25);
echo $v2-> demarrer();
echo $v2-> decelerer(10);
echo $v2-> stopper();
